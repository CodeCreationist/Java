// FILE: GamerGuess.java
// This program illustrates the use of the binary tree node class.
...
public class AnimalGame
{
   ...
   * gamer-guessing game. As the game is played, the taxonomy tree
   * grows by learning new gamer types. The <CODE>String</CODE> argument
   ...
   **/
   ...
   /**
   * Print instructions for the gamer-guessing game.
   **/
   public static void instruct( )
   {
      System.out.println("Please think of your gamer type.");
      System.out.println("I will ask some yes/no questions to try to figure");
      System.out.println("out what type of gamer you are.");
   }
   

   /**
   * Play one round of the gamer guessing game.
   ...
   *   added new information about a new gamer type.
   ...
   **/
   ...
   /**
   * Construct a small taxonomy tree with four gamertypes.
   * @param - none
   * @return
   *   a reference to the root of a taxonomy tree with the gamer types:
   ...
   **/
   public static BTNode<String> beginningTree( )   
   {
      ...
      final String ROOT_QUESTION = "Do you like games?";
      final String LEFT_QUESTION = "Do you like difficult games?";
      final String RIGHT_QUESTION = "Are you having fun?";
      final String TYPE1 = "Boring";
      final String TYPE2 = "Opportunist";
      final String TYPE3 = "Noob";
      final String TYPE4 = "Pro";
    
      // Create the root node with the root question
      ...
      child.setLeft(new BTNode<String>(TYPE4, null, null));
      child.setRight(new BTNode<String>(TYPE3, null, null));
      root.setLeft(child);

      // Create and attach the right subtree.
      child = new BTNode<String>(RIGHT_QUESTION, null, null);
      child.setLeft(new BTNode<String>(TYPE2, null, null));
      child.setRight(new BTNode<String>(TYPE1, null, null));
      root.setRight(child);
   ...
   **/
   ...
   // has been improved.
   {
      String guessType;   // The type that was just guessed
      String correctType; // The type that the user was thinking of
      String newQuestion;   // A question to distinguish the two types
      
      // Set Strings for the guessed type, correct type and a new question.
      guessType = current.getData( );
      System.out.println("I give up. What are you? ");
      correctType = stdin.nextLine( );
      System.out.println("Please type a yes/no question that will distinguish a");
      System.out.println(correctType + " from a " + guessType + ".");
      newQuestion = stdin.nextLine( );
      
      // Put the new question in the current node, and add two new children.
      current.setData(newQuestion);
      System.out.println("As a " + correctType + ", " + newQuestion);
      if (query("Please answer"))
      {
         current.setLeft(new BTNode<String>(correctType, null, null));
         current.setRight(new BTNode<String>(guessType, null, null));
      }
      else
      {
         current.setLeft(new BTNode<String>(guessType, null, null));
         current.setRight(new BTNode<String>(correctType, null, null));
      }         
   }
